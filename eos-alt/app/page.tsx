              ...
              {validAlerts.map((center) => (
                <div key={center.id} className="bg-panel border border-border p-4 rounded-xl flex flex-col">
                  <div className="flex justify-between items-start mb-2 gap-2">
                    ...
                    <span className="text-xs font-medium bg-background px-2 py-0.5 border border-border rounded-md whitespace-nowrap">
                      {center.negeri}
                    </span>
                  </div>
                  ...
                  <div className="mt-4 pt-2 border-t border-border/30 text-xs text-foreground/40 flex flex-col gap-1">
